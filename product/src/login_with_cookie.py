...
from product.src import COOKIES_DIR
from product.src.data import NetworkError
...
def logInWithCookies(target_url: str = "https://www.jd.com/", retry: int = 0, context: Optional[BrowserContext] = None):
    """
    使用 cookies 模拟登录
